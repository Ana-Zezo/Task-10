...
// $doctors = $sql->getPaginatedData("doctors", 2, 3);
$doctors = $sql->getPaginatedData("doctors", 2, 3);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        ...
                        if (!isset($_SESSION["auth"])) {
                            ...
                            ?>
                            <a type="button" class="btn btn-outline-light navigation--button"
                                href="../pages/history.php">Booking</a>
                            <a type="button" class="btn btn-danger navigation--button" <a type="button"
                                class="btn btn-danger navigation--button"
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="fw-bold my-4 h4">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="../../index.php">Home</a>
                    </li>
                ...
                foreach ($doctors as $doctor) {
                    ...
                    foreach ($majors as $major) {
                        ...
                        <div class="card p-2" style="width: 18rem;">
                            <img src="../../Admin/assets/img/doctor/<?= $doctor["image"] ?>" class=" card-img-top rounded-circle
                        card-image-circle" alt="major">
                            <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                ...
                                if (isset($_SESSION["auth"])) {
                                    ?>
                                    <a href="./doctor.php?doctor_id=<?= $doctor["id"] ?>"
            ...
            <nav class="mt-5" aria-label="navigation">
                <ul class="pagination justify-content-center">
                    <li class="page-item  ">
                        <a class="page-link page-prev text-bg-primary " href="./index.php" aria-label="Previous">
                    ...
                    <li class="page-item">
                        <a class="page-link page-next text-bg-primary" href="./index.php" aria-label="Next">
